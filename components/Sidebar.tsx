...
import {LayoutDashboard, MessageSquare, Settings,ImageIcon,VideoIcon,Music,Code } from "lucide-react"
    ...
    <div className="space-y-4 py-4 flex flex-col h-full bg-[#111827] text-white">
      <div className="px-3 py-2 flex-1">
        ...
        <div className="relative w-8 h-8 mr-4">
          <Image fill alt="Ethernal Logo" src="/logo.png" /> 
        </div>
        <h1 className={cn("text-2xl font-bold", montserrat.className)}>Ethernal</h1>
        </Link>
